...
{
	if ((*room->GetPUserMoneyVector())[room->GetTakeControlPlayer()] + room->TotalDisposalPrice() < 0)	// 카드 사용 후 돈 없으면
	{
		room->Bankruptcy(room->GetTakeControlPlayer());		// 파산 처리
...
void GameManager::CheckGameOver(GameRoom* room)
{
